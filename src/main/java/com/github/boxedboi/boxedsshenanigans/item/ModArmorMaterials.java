...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    SCARFED("scarfed", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0f, 0.1f, () -> Ingredient.ofItems(ModItems.CLOTH))
    ;
    ...
    public String getName() {
        return BoxedsShenanigans.MOD_ID + ":" + this.name;
    }
